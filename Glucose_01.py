...
plt.plot(days, [i * 200 for i in PA_000_GLU_A1], label="P.A. 0.00 M", marker="o")
plt.plot(days, [i * 200 for i in PA_005_GLU_A1], label="P.A. 0.05 M", marker="o")
plt.plot(days, [i * 200 for i in PA_010_GLU_A1], label="P.A. 0.10 M", marker="o")
plt.plot(days, [i * 200 for i in PA_015_GLU_A1], label="P.A. 0.15 M", marker="o")
plt.plot(days, [i * 200 for i in PA_020_GLU_A1], label="P.A. 0.20 M", marker="o")
plt.plot(days, [i * 200 for i in PA_030_GLU_A1], label="P.A. 0.30 M", marker="o")
plt.plot(
    days,
